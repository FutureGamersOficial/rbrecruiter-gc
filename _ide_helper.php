...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function toUUID($username)
        {
                        /** @var \App\UUID\UUID $instance */
                        return $instance->toUUID($username);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function toUsername($uuid)
        {
                        /** @var \App\UUID\UUID $instance */
                        return $instance->toUsername($uuid);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function shouldCollect()
        {
                        /** @var \App\CustomFacades\IP $instance */
                        return $instance->shouldCollect();
        }
                    /**
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getValidator($fields, $generateStructure = false, $includeFormName = false)
        {
                        /** @var \App\Helpers\ContextAwareValidator $instance */
                        return $instance->getValidator($fields, $generateStructure, $includeFormName);
        }
                    /**
         ...
         * @return \Validator|\Illuminate\Support\Collection A collection or a validator, depending on the args. Will return validatior if only fields are supplied.
         * @static 
         */ 
        public static function getResponseValidator($fields, $formStructure = [], $generateResponseStructure = true)
        {
                        /** @var \App\Helpers\ContextAwareValidator $instance */
                        return $instance->getResponseValidator($fields, $formStructure, $generateResponseStructure);
        }
     ...
     */ 
         ...
         * @return \Illuminate\Support\Collection The settings in this category
         * @static 
         */ 
        public static function getCategory($category)
        {
                        /** @var \App\Helpers\Options $instance */
         ...
         * @static 
         */ 
        public static function setOption($option, $value, $description, $category = null)
        {
                        /** @var \App\Helpers\Options $instance */
                        return $instance->setOption($option, $value, $description, $category);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function pullOption($option)
        {
                        /** @var \App\Helpers\Options $instance */
                        return $instance->pullOption($option);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function changeOption($option, $newValue)
        {
                        /** @var \App\Helpers\Options $instance */
                        return $instance->changeOption($option, $newValue);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Helpers\Options $instance */
                        return $instance->optionExists($option);
        }
     ...
     */ 
        ...
        public static function setResponseType($type)
        {
                        ...
                        return $instance->setResponseType($type);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function setAdditional($additional)
        {
                        /** @var \App\Helpers\JSON $instance */
                        return $instance->setAdditional($additional);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * @param string $key
         * @param mixed $value
         * @param \GeoSot\EnvEditor\array<string,  int|string>  $options
         * @return bool 
         * @throws EnvException
         * @static 
         */ 
...
namespace  { 
            ...
            class UUID extends \App\Facades\UUID {}
            class IP extends \App\Facades\IP {}
            class Markdown extends \GrahamCampbell\Markdown\Facades\Markdown {}
            class ContextAwareValidator extends \App\Facades\ContextAwareValidation {}
            class Settings extends \App\Facades\Options {}
            class JSON extends \App\Facades\JSON {}
